...
# subtract black background counts from the measurements
still_counts = (still - black)
stormy_counts = (stormy - black)
breeze_counts = (breeze - black)

colors = sns.color_palette("Blues", 4)[1:4]
...
### Plot the spectral irradiance for each light regime and the lunar spectrum
plt.figure(figsize=(7, 4))

# Plot the spectral irradiance for each light regime 
